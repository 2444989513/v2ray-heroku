#!/bin/sh
# Download and install V2Ray https://github.com/v2ray/v2ray-core/releases/download/v4.23.0/v2ray-linux-64.zip
...
curl -L -H "Cache-Control: no-cache" -o /v2ray.zip https://github.com/v2ray/v2ray-core/releases/download/v4.23.0/v2ray-linux-64.zip
